...
export interface AgentRun { _id: string; runId: string; status: string; prompt: string; intent?: any; selectedSkill?: any; plan?: any[]; sources?: SourceRef[]; filteredChunks?: any[]; artifacts?: Artifact[]; trace?: any[]; logs?: any[]; answer?: string; createdAt?: string; review?: any; controlState?: any; provider?: Record<string, unknown>; quality?: RunQuality; evalCaseId?: string; stateTransitions?: any[]; reviewHistory?: any[]; controlHistory?: any[]; evalResult?: any; }
